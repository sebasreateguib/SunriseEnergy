...
export function ProjectShowcase({ projects }: ProjectShowcaseProps) {
    ...
    return (
        <>
            {/* Mobile y tablet: mazo de tarjetas con la foto sin nada encima. */}
            <ProjectDeck projects={projects} />

            {/* Desde 1024px: foto a sangre con las tabs y la ficha flotando encima. */}
            <div className="relative mx-auto hidden max-w-7xl px-6 lg:block">
                ...
                {/* IMAGE CONTAINER */}
                <div
                    className="relative h-[690px] overflow-hidden"
                    style={{
